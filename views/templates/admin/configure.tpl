...
<div class="panel">
	<h3><i class="icon icon-truck"></i> {l s='My shipping module' mod='sendcloud'}</h3>
	<img src="{$module_dir|escape:'html':'UTF-8'}/logo.png" id="payment-logo" class="pull-right" />
	<p>
		<strong>{l s='Here is my new shipping module!' mod='sendcloud'}</strong><br />
		{l s='Thanks to PrestaShop, now I have a great shipping module.' mod='sendcloud'}<br />
